...
contract VotingContract {
    ...
    function addVoter(string memory _voter_name, string memory _email_id) public {
        ...
        votersCount++;
        voters[msg.sender] = Voter(votersCount, _voter_name, _email_id, _roll_no, msg.sender, false);
...
///-----------------------------------------------------------------------------------------------------
    ...
    modifier chairpersonOnly() {
        require (msg.sender == "Chairman can set time limit");
        _;
    }
...
//-------------Voting function-----------------
    function vote (uint _candidateid) public {
        ...
        require (block.timestop <= stopTime, "Election over");
